...
"syn keyword javaScriptReserved        abstract boolean byte char debugger
...
syn match  javaScriptProperty        "\v(\.\.)@<!\.\_s*\k+"
            \ contains=javaScriptFuncCall

syn match javaScriptFuncCall "\k\+\ze\_s*("
syn match javascriptConstructor "\k\+\ze\_s*(" contained
syn match javaScriptNew "\<new\>" skipwhite nextgroup=javaScriptConstructor
...
if exists("javaScript_fold")
    ...
    syn keyword javaScriptFunction  function constructor static
...
if version >= 508 || !exists("did_javascript_syn_inits")
    ...
    HiLink javaScriptNew              javaScriptOperator
    HiLink javaScriptType             Type
    HiLink javaScriptStatement        Statement
    HiLink javaScriptAsyng            Statement
    ...
    HiLink javaScriptExport           Keyword
